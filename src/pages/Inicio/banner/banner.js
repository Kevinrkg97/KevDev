...
const Banner = () => {
        ...
        <div class="header">
            ...
            <div class="inner-header flex">
                <svg version="1.1" class="logo" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xlinkHref="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" xmlSpace="preserve">
                    <path fill="#222" stroke="#F9A826" stroke-width="10" stroke-miterlimit="10" d="M57,283" />
                    <g><path fill="#222"
	...
	<div class="sp-content">
		...
		<h2 class="frame-1">Desarrollo Full Stack</h2>
		<h2 class="frame-2">Científico de datos</h2>
		<h2 class="frame-3">Diseñador</h2>
